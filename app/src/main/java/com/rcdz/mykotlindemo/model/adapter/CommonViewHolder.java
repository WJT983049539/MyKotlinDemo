...
public class CommonViewHolder extends RecyclerView.ViewHolder {
     ...
     * 设置条目点击事件
     */
    public void setOnIntemClickListener(int viewId,View.OnClickListener listener) {
     ...
     * 设置条目长按事件
     */
    public void setOnIntemLongClickListener(int viewId,View.OnLongClickListener listener) {
        View imageView = getView(viewId);
